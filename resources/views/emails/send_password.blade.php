...
<head>
    ...
    <style>
        ...
        @media only screen and (max-width: 650px) {
            ...
            .h1-mobile{
                font-size: 20px!important; /* Smaller font size for headers on mobile */
            }
            .store-icons img {
    ...
    <table class="wrapper" width="800" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin:0 auto">
        ...
        <tr>
            <td class="content" valign="top" style="width: 60%;">
                <h1 class="h1-mobile">შენ უკვე <strong>ESCARD</strong>-ის <br> წევრი ხარ</h1>
                <p>აპლიკაციაში ავტორიზაციისთვის<br> გამოიყენე შენი მეილი და ერთჯერადი <br> პაროლი:</p>
                <h3>E-mail: <span style="color: #0667f9;">{{$email}}</span></h3>
