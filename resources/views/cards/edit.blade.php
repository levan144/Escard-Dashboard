                                ...
                                <div class="basic-form">
                                    <form action="{{route('cards.update', $card->id)}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="color" name="color" value="{{$card->color}}" class="form-control input-rounded">
                                        </div>
                                        <div class="form-group">
                                            <img class="mr-3 img-fluid " width="60" src="{{$card->featured_image}}" alt="Card" class="m-4">
                                            <label>Featured Image</label>
                                            <input type="file" name="featured_image" class="form-control input-rounded mt-4">
                                        </div>
