                                ...
                                <div class="basic-form">
                                    <form action="{{route('categories.store')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="color" name="color" class="form-control input-rounded" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Icon</label>
                                            <input type="file" name="icon" class="form-control input-rounded" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Icon Hover</label>
                                            <input type="file" name="icon_hover" class="form-control input-rounded" required>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="form-check">
                                                                ...
                                                                <input class="form-check-input" type="radio" name="language" checked value="ka" >
                                                                    Georgian
                                                                </label>
                                                            </div>
                                                            <div class="form-check">
                               ...
                               <div class="basic-list-group">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            {{$category->name}} 
                                            <div><a href="{{route('categories.edit', $category->id)}}"><span class="badge badge-primary badge-pill"><i class="fa fa-pencil"></i></span></a>
                                            <a href="{{route('categories.delete', $category->id)}}"><span class="badge badge-danger badge-pill"><i class="fa fa-trash"></i></span></a></div>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
